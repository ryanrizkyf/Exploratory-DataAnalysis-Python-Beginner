# Sorting adalah sebuah metode mengurutkan data berdasarkan syarat kolom tertentu,
# dan biasanya digunakan untuk melihat nilai maksimum dan minimum dari dataset.
...
# Contoh nya pada skenario dibawah, akan mencoba mengaplikasikan fungsi Sorting menggunakan Age dan Score sekaligus:
# Syntax
# nama_datafrmae.sort_values(by=["nama_kolom_1", "nama_kolom_2"], ascending=[False, True])
# Contoh
